...
## I open my graphics file device, make my figures, and close my file device. 
png(filename = "plot4.png")
par(mfrow = c(2, 2))
with(selectedrows, {
        plot(selectedrows$DateTime,selectedrows$Global_active_power, type = "l", ylab = "Global Active Power (kilowatts)", xlab = "")
